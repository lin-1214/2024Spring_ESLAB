...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc) { event_queue.call(timer_count_callback); }
...
void ADC1_Init(void) {
    ...
    sConfig.SamplingTime = ADC_SAMPLETIME_6CYCLES_5;  // origin: ADC_SAMPLETIME_2CYCLES_5;
...
static void TIM1_Init(void) {
    ...
    // htim1.Init.Period = 50000 - 1; // 3 sec
