...
#include "ble/services/LEDService.h"
#include "pretty_printer.h"

#define LD1_TOG {_led1 = !_led1;}

const static char DEVICE_NAME[] = "Team3QQQ";
...
public:
    BatteryDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _button_service(ble, true),
        _button_uuid(ButtonService::UUID_BUTTON_SERVICE),
        _led_service(ble, true),
        _led_uuid(LEDService::UUID_LED_SERVICE),
...
private:
    ...
    void on_data_written(const GattWriteCallbackParams *params) {
        ...
        printf("Receive value from client: %c\r\n", value[0]);
